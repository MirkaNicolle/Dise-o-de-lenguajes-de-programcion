...
class LexicalApp:
    def __init__(self, master):
        ...
        self.load_yalex_button = tk.Button(master, text="Load YALex Specifications", command=self.load_yalex, #boton yalex
        ...
        self.load_text_button = tk.Button(master, text="Load Text File", command=self.load_text_file, #boton archivo a analizar
        bg='#D8BFD8', fg='black', font=button_font, relief='flat', bd=0,
        activebackground='#DA70D6', activeforeground='white')
